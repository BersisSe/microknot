...
Keep it atomic: Try to keep pull requests focused on a single logical change.
...
AI Usage: While permited PR's with AI written text might get rejected.

## 🧩 Contributing Node Types

The heart of Microknot is its extensible node system. When contributing a new node type (e.g., transform.* or notify.*):
